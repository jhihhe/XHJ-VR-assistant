...
![版本](https://img.shields.io/badge/版本-v1.43-brightgreen)
...
*   **UI/UX 深度优化 (v1.43)**：新增 **V2EX Pro** 极简白主题，全局应用 Pill Tabs (胶囊标签页) 与 Capsule Inputs (全圆角输入框) 设计语言。
...
*   🌊 **Midnight Blue** (v1.42 新增 - 深海沉浸蓝)
*   ⚪️ **V2EX Pro (Light)** (v1.42 新增 - 极简白风格)
*   🌇 **Synthwave '84** (v1.42 新增 - 复古霓虹紫)
